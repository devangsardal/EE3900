...
\solution Download the python code from
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/kn-vardhan/EE3900-Digital-Signal-Processing/main/Charger/codes/2_3.py
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/kn-vardhan/EE3900-Digital-Signal-Processing/main/Charger/codes/3_8.py
\end{lstlisting}
Verifying \eqref{eq:fourier-xt}
...
Download the python code from
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/kn-vardhan/EE3900-Digital-Signal-Processing/main/Charger/codes/3_9.py
\end{lstlisting}
Verifying \eqref{eq:fourier-rect}
...
This circuit is simulated in the ngspice code \lstinputlisting{./codes/5_3.cir}.\\
Download the python code from
\begin{lstlisting}
...
This circuit is simulated in the ngspice code \lstinputlisting{./codes/5_4.cir}
Download the python code from
\begin{lstlisting}
